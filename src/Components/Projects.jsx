    ...
    <div className="flex text-white h-screen">
      ...
      <div className="w-full flex flex-col sm:flex-row justify-around">
        ...
        <div className="w-full mt-5 sm:w-1/3 sm:mt-0 flex flex-col items-center justify-center">
          ...
          <p className="text-2xl mt-10 flex items-center gap-3">Tech Stack used: <FaReact className="text-blue-400"/> <RiTailwindCssFill className="text-blue-400"/>  <FaPhp className="text-blue-800"/>  <SiMysql className="text-blue-400"/>  <FaGitAlt className="text-red-400"/>  <FaGithub /></p>
        </div>
      </div>
    </div>
  )
