      ...
      <div className="flex justify-around h-96">
        <div className="text-white flex flex-col justify-center ">
          ...
          <div className="flex w-2/3 items-center justify-around mt-5">
            ...
            <a href="./Resume - Perillo, Jesner Arlan D..pdf" download="Resume - Perillo, Jesner Arlan D."><button className="duration-150 flex bg-red-500 text-white p-2 w-36 items-center justify-around rounded hover:bg-white hover:text-red-500">Download CV <BsDownload /></button></a>
          </div>
        </div>
