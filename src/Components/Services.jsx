  ...
  return (
    <div className="w-full h-screen flex flex-col justify-center">
      ...
      <div className="h-1/2 flex justify-evenly flex-col sm:flex-row sm:h-1/3">
        {/*Right Side */}
        <div className="bg-gray-800 border text-white h-full w-full flex flex-col p-2 items-center justify-around rounded mb-10 hover:scale-105 transition-transform cursor-pointer sm:w-1/3 sm:mb-0">
          ...
          <div className="flex justify-center items-center">
            ...
            <img src={TailwindLogo} alt="Tailwind Logo" className="w-28 h-16 sm:w-40 sm:h-24"/>
          </div>
        </div>
        {/*Left Side */}
